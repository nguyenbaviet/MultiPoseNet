...
from src.datasets.coco_data.COCO_data_pipeline import Cocokeypoints, Cocobbox, bbox_collater
from src.datasets.dataloader import sDataLoader
from pycocotools.coco import COCO


def get_loader(json_path, data_dir, mask_dir, inp_size, feat_stride, preprocess,
               batch_size, training=True, shuffle=True, num_workers=3, subnet='keypoint'):
    ...
    elif subnet == 'detection':
        mask_dir = os.path.abspath(os.path.join(mask_dir, os.pardir))
        if training:
